var ElementimageNumWidth = document.getElementById("scrollbgId").getAttribute("data-value");
var Elementleft = document.getElementById("scrollbgId").getAttribute("data-left");
var Elementcurrentmax = document.getElementById("scrollbgId").getAttribute("data-max");
var Elementcurrentmin = document.getElementById("scrollbgId").getAttribute("data-min");

var img = {
	
	 imageNumWidth:ElementimageNumWidth,
	 num:0,
	 ...
	 init:function(){
		...
		img.current.style.left = Elementleft+"px";
	...
	play:function(i){
		...
		if(i>img.num){
			...
			if(parseInt(img.current.style.left)>Elementcurrentmax){
				//如果活动框到了最右边--完成
				//小图片向左
			...
			img.imagebg_li[i].style.display = "block";
			//如果比当前小;
			if(parseInt(img.current.style.left)<Elementcurrentmin){
				//如果活动框到了最左边
				//小图片向右
				img.animate = setInterval(function(){
